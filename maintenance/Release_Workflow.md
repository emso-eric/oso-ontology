...
The authoritative OSO ontology maintained by developers as the Turtle source file (`OSO.ttl`). All ontology modifications are performed on this file.
...
RDF serialisation formats and metadata files automatically generated from the source ontology (e.g. RDF/XML, JSON-LD, N-Triples, DCAT and VoID).

### Documentation artefacts

The human-readable documentation generated by Widoco and published through GitHub Pages.

### Release artefacts

The complete set of files published for a given OSO release, including the source ontology, generated distributions, documentation and archived version.
