...
| Term | Definition |
|------|------------|
| **Source ontology** | The authoritative OSO ontology maintained by developers as the Turtle source file (`OSO.ttl`). All modifications are performed on this file. |
| **Ontology metadata** | Version information, dates, ontology statistics and descriptive metadata embedded directly in the ontology. |
| **Distribution artefacts** | All RDF serialisations and metadata files automatically generated from the source ontology (e.g. RDF/XML, JSON-LD, N-Triples, DCAT and VoID). |
| **Documentation artefacts** | The human-readable ontology documentation generated by Widoco and published through GitHub Pages. |
| **Release artefacts** | The complete set of files published for a given OSO release, including the source ontology, distribution artefacts, generated documentation and archived version. |
